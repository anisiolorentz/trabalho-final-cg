...
- `A aplicação será inspirada no vídeo de referência, mas não será uma cópia exata da cena original. O foco será reproduzir a ideia de sala de puzzle com objetos geométricos, mesa e objetivo de alcançar uma região elevada, mas não necessariamente os objetos irão crescer e expandir de acordo com movientação da câmera.`
